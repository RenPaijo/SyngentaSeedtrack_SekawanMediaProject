export class Locator {
	...
	inputName = 'input[name="VendorName"]';
	inputCode = 'input[name="VendorCode"]';
	inputDirectorName = 'input[name="VendorDirectorName"]';
	inputAddress = 'input[name="VendorAddress"]';
	inputPhone = 'input[name="VendorPhone"]';
